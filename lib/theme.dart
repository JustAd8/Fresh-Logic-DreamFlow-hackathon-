...
// =============================================================================
// COLORS - ECO-FRIENDLY TECH PALETTE
// =============================================================================

/// Light mode colors with eco-friendly sage green theme
class LightModeColors {
  // Primary: Sage Green
  static const lightPrimary = Color(0xFF7C9A7F);
  static const lightOnPrimary = Color(0xFFFFFFFF);
  static const lightPrimaryContainer = Color(0xFFE8F3EA);
  static const lightOnPrimaryContainer = Color(0xFF2A4A2E);

  // Secondary: Charcoal
  static const lightSecondary = Color(0xFF2C3333);
  static const lightOnSecondary = Color(0xFFFFFFFF);
  static const lightSecondaryContainer = Color(0xFFE5E7E7);
  static const lightOnSecondaryContainer = Color(0xFF1A1C1C);

  // Alert: Soft Red for expired items
  static const lightError = Color(0xFFE57373);
  static const lightOnError = Color(0xFFFFFFFF);
  static const lightErrorContainer = Color(0xFFFFEBEE);
  static const lightOnErrorContainer = Color(0xFF8C1D18);
  ...
  static const lightOnSurface = Color(0xFF1A1C1B);
  static const lightBackground = Color(0xFFF5F8F6);
  static const lightSurfaceVariant = Color(0xFFEDF2EF);
  static const lightOnSurfaceVariant = Color(0xFF404944);

  // Outline and shadow
  static const lightOutline = Color(0xFFC2CCC5);
  static const lightShadow = Color(0xFF000000);
  static const lightInversePrimary = Color(0xFFA5C4A8);
}

/// Dark mode colors with eco-friendly theme
class DarkModeColors {
  // Primary: Lighter sage for dark background
  static const darkPrimary = Color(0xFFA5C4A8);
  static const darkOnPrimary = Color(0xFF2A4A2E);
  static const darkPrimaryContainer = Color(0xFF5F7D62);
  static const darkOnPrimaryContainer = Color(0xFFE8F3EA);

  // Secondary: Lighter charcoal
  static const darkSecondary = Color(0xFFB8BDBD);
  static const darkOnSecondary = Color(0xFF1A1C1C);
  static const darkSecondaryContainer = Color(0xFF3F4444);
  static const darkOnSecondaryContainer = Color(0xFFE5E7E7);

  // Alert: Soft red maintained for visibility
  ...
  static const darkOnSurface = Color(0xFFE1E8E3);
  static const darkSurfaceVariant = Color(0xFF404944);
  static const darkOnSurfaceVariant = Color(0xFFC2CCC5);

  // Outline and shadow
  static const darkOutline = Color(0xFF7F8A84);
...
ThemeData get darkTheme => ThemeData(
  ...
  cardTheme: CardThemeData(
    ...
    shape: RoundedRectangleBorder(
      borderRadius: BorderRadius.circular(16),
      side: BorderSide(
        color: DarkModeColors.darkOutline.withValues(alpha: 0.15),
        width: 1,
      ),
    ),
  ),
